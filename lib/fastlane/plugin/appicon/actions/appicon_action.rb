  ...
  module Actions
    class AppiconAction < Action
      ...
      def self.run(params)
        ...
        basename = params[:appicon_basename] || File.basename(fname, File.extname(fname))
          ...
          FastlaneCore::ConfigItem.new(key: :appicon_name,
                             ...
                             default_value: 'AppIcon.appiconset',
                               description: "Name of the appiconset inside the asset catalogue",
                                  optional: true,
                                      type: String),
          FastlaneCore::ConfigItem.new(key: :appicon_basename,
                                  env_name: "APPICON_BASENAME",
                             default_value: nil,
                               description: "Base name to save icons to (e.g. <appicon_basename>-60x60@3x.png",
                                  optional: true,
                                      type: String),
